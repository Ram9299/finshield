...
class FraudFlowIT {
    ...
    private UUID createUserAndAccount() {
        ...
        Map<String, Object> userResp = post("/api/users", Map.of(
                "fullName", "Test User",
                "email", email,
                "country", "IN"
        ));
        ...
        Map<String, Object> accResp = post("/api/accounts", Map.of(
                "userId", userId.toString()
        ));
        return uuid(accResp, "id");
    }

    private Map<String, Object> txn(UUID accountId, BigDecimal amount, String country, String deviceId, String ip) {
